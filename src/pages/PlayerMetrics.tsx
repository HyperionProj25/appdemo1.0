      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', padding: '20px 28px 14px' }}>
        ...
        <div style={{ display: 'flex', gap: 16, flexShrink: 0 }}>
          ...
          <div className="anim-slide-up anim-delay-6" style={{ flex: 1, background: 'var(--card-bg)', border: '1px solid var(--card-border)', borderRadius: 8, padding: '18px' }}>
            ...
            <div style={{ marginBottom: 14 }}><div style={{ color: 'var(--accent)', fontSize: 13, fontWeight: 700, fontStyle: 'italic', marginBottom: 4 }}>9/25/25</div><div style={{ fontSize: 13, fontWeight: 700, textTransform: 'uppercase', lineHeight: 1.4 }}>NORCAL WORLD SERIES</div></div>
            <div style={{ marginBottom: 14 }}><div style={{ color: 'var(--accent)', fontSize: 13, fontWeight: 700, fontStyle: 'italic', marginBottom: 4 }}>8/20/25</div><div style={{ fontSize: 13, fontWeight: 700, textTransform: 'uppercase', lineHeight: 1.4 }}>CCB CLASSIC</div></div>
          </div>
        </div>
      </div>
